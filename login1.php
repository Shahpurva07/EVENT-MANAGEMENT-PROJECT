...
and password='".md5($password)."'";
	...
	$rows = mysqli_num_rows($result);
	   ...
	   echo "<div class='pphp'>
            <div class='divtwo'>
<center><br/><h3>You are successfully logged in.</h3>
<br/>Click login to try <a href='services.html'><input class='but' type='submit' value='go to services' /></a></center></div></div>";    
         }else{
	echo "<div class='pphp'>
            <div class='divtwo'>
<center><br/><h3>Username/Password is incorrect</h3>
<br/>Click login to try <a href='loginform.php'><input class='but' type='submit' value='Login' /></a> again.</center></div></div>";
	}
    }else{
?>
                ...
                <div id="wrapper" style="opacity: 0.95;">
                    <div id="login" class="animate form">
                        <form action="" name="loginform" method="post" autocomplete="on" onsubmit="return validate();">
                            ...
                            <p style=" margin-top:60px;float:right;" class="change_link">
                                For admin login click here 
                                <a href="adminlogin.php" class="to_register">Admin Login</a>
                            </p>
                        </form>
                    </div>
                </div>
